...
function Homepage() {
      ...
      <div className="flex flex-col  md:flex-row justify-around relative mt-8">
        ...
        <div className="w-full md:w-[35%] px-[5%] md:border-r-2 border-black-500">
          <ul className="flex flex-col items-start gap-4 md:gap-0">
            <li className="text-[4vw] md:text-[1.5vw] cursor-pointer hover:bg-[#F5F5F5] hover:border-l-4">
              {`Woman's Fashion`}
            </li>
            <li className="text-[4vw] md:text-[1.5vw] cursor-pointer  hover:bg-[#F5F5F5] hover:border-l-4">
              {`Men's Fashion`}
    ...
    />
      ...
      <div className="border-b-2 border-black-500">
        <div className=' flex justify-between items-center p-10'>
          <div>
            <h1 className='sm:text-[1.5vw] md:font-bold text-[2vw]'>Flash Sale</h1>
          </div>
        ...
        <div className='flex flex-wrap sm:flex-col md:flex-row justify-evenly gap-4 sm:gap-2 sm:text-sm'>
          {/* Product 1 */}
          <div className="flex flex-col sm:w-[80%] md:w-[20%] sm:items-center">
    ...
    />
      ...
      <div>
        <div className='flex justify-between items-center p-7'>
          <div className='font-bold text-xl'>Browse By Category</div>
          <div className='flex gap-2'>
  ...
  <div className='flex sm:flex-col md:flex-row justify-center gap-5 mb-5'>
    ...
    <div className='flex flex-col items-center'>
      ...
      <div className='flex gap-3'>
        <p className='text-[1.5vw] text-red-600'>$120</p>
  ...
  {[...Array(5)].map((_, i) => (
    ...
    <div className='flex flex-col items-center'>
      ...
      <div className='flex gap-3'>
        <p className='text-[1.5vw] text-red-600'>$960</p>
        <p className='text-[1.5vw]'>$160</p>
      </div>
      <div className="flex space-x-1 mt-2">
  {[...Array(5)].map((_, i) => (
